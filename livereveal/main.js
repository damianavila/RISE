...
function Revealer(ttheme, ttransition, bgimgpath){
  ...
  require(['custom/livereveal/reveal.js/lib/js/head.min',
    ...
    parallaxBackgroundImage: Reveal.getQueryHash().parallaxBackgroundImage || bgimgpath //'https://raw.github.com/damianavila/par_IPy_slides_example/gh-pages/figs/star_wars_stormtroopers_darth_vader.jpg',
